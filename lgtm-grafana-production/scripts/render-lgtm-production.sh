...
PROD_DIR="${ROOT_DIR}"
OUT_DIR="${OUT_DIR:-${ROOT_DIR}/.rendered}"
...
cp "${PROD_DIR}/namespaces.yaml" "${OUT_DIR}/namespaces.yaml"
cp "${PROD_DIR}/manifests/minio-sandbox.yaml" "${OUT_DIR}/minio-sandbox.yaml"
